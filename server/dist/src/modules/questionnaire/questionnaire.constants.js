...
exports.default = {
    ...
    SRC_QUESTIONNAIRE_TEMPLATE: (course) => __dirname + "/templates/templates/" + course + "/index.ejs",
    SRC_QUESTIONNAIRE_OUTPUT: (_id) => __dirname + `/../../../public/upload/files/${_id}.pdf`,
    SRC_QUESTIONNAIRE_OUTPUT_ONEPAGE: (_id) => __dirname + `/../../../public/upload/files/${_id}_onepage.pdf`,
};
//# sourceMappingURL=questionnaire.constants.js.map