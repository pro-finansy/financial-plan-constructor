...
exports.base64_encode = exports.parseLinks = exports.getCurrentExchangeRates = exports.periods = exports.secondQuestionnaireColors = exports.firstQuestionnaireColors = exports.secondQuestionnaireRisks = exports.firstQuestionnaireRisks = exports.secondQuestionnaireInfo = exports.firstQuestionnaireInfo = exports.getConvert = void 0;
const fs_1 = __importDefault(require("fs"));
const convertModel = require('../../../convert/convert.model').default;
let convert = { list: {} };
function getConvert() {
    return __awaiter(this, void 0, void 0, function* () {
        convert = yield convertModel.findOne();
    });
}
exports.getConvert = getConvert;
getConvert();
exports.firstQuestionnaireInfo = [
...
exports.secondQuestionnaireInfo = [
...
exports.firstQuestionnaireRisks = [
    {
        name: 'Осторожный',
        tag: 'осторожном',
...
exports.secondQuestionnaireRisks = [
    {
        name: 'Осторожный',
        tag: 'осторожном',
...
exports.firstQuestionnaireColors = ["#FCC033", "#369B5F", "#F44336", "#5C6BC0", "#FD9500", "#9B5DE5", "#5DE589", "#E57B32", "#32DEE5", "#DE32E5", "#A4E51C", "#787EFF", "#50AA9B", "#FF7886", "#E000FF", "#FFCACA", "#93B3FF", "#FF00D8", "#FF0074", "FFF861"];
exports.secondQuestionnaireColors = ["#FFE27A", "#B5C465", "#74A25A", "#3B7E51", "#8771A3", "#654978", "#00A7A7", "#008D8D", "#006A6A", "#DE32E5", "#A4E51C", "#787EFF", "#50AA9B", "#FF7886"];
exports.periods = {
...
exports.default = { base64_encode, parseLinks, getConvert, getCurrentExchangeRates, periods: exports.periods, firstQuestionnaireInfo: exports.firstQuestionnaireInfo, secondQuestionnaireInfo: exports.secondQuestionnaireInfo, firstQuestionnaireRisks: exports.firstQuestionnaireRisks, secondQuestionnaireRisks: exports.secondQuestionnaireRisks, firstQuestionnaireColors: exports.firstQuestionnaireColors, secondQuestionnaireColors: exports.secondQuestionnaireColors };
